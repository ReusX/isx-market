...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const statics: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/gold`,        lastModified: now, changeFrequency: 'hourly',  priority: 0.8 },
    ...
    { url: `${BASE}/quests`,      lastModified: now, changeFrequency: 'weekly',  priority: 0.4 },
    { url: `${BASE}/rewards/spin`,lastModified: now, changeFrequency: 'daily',   priority: 0.3 },
  ]
