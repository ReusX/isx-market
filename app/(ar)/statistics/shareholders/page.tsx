...
export const metadata: Metadata = {
  ...
  title: 'كبار المساهمين | IQWealth',
  description: 'أكبر الحصص المُفصح عنها في شركات سوق العراق للأوراق المالية، بنسبة ملكية كل مساهم، من آخر تقرير إيداع شهري متاح.',
}
