...
export const metadata: Metadata = {
  title: { absolute: 'رادار الأسهم العراقية · فلترة أسهم بورصة العراق' },
  ...
  openGraph: {
    url: absUrl('/screener'),
    title: 'رادار الأسهم العراقية · بورصة العراق',
...
export default function ScreenerLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <Breadcrumbs trail={[{ name: 'رادار الأسهم', path: '/screener' }]} />


      <Freshness
        url={absUrl('/screener')}
        name="رادار الأسهم العراقية"
