    ...
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: 'var(--gold)', lineHeight: 1.7, margin: 0, fontWeight: 600 }}>
          {ar
            ? 'ISX Market ليست شركة وساطة مالية مرخصة ولا تقدم نصائح استثمارية. جميع المعلومات على المنصة لأغراض إعلامية وتعليمية فقط.'
            : 'ISX Market is not a licensed brokerage and does not provide investment advice. All information on this platform is for informational and educational purposes only.'}
        </p>
      </div>
