 ...
 */
const REBUILT = ['/market', '/companies', '/screener', '/heatmap', '/statistics', '/pulse', '/c', '/banks', '/fx', '/gold', '/oil', '/silver', '/news', '/portfolio', '/watchlist', '/alerts', '/login', '/signup', '/forgot-password', '/verify-email', '/auth/reset', '/profile']
