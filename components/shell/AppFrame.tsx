 ...
 */
const REBUILT = ['/market', '/companies', '/screener', '/heatmap', '/statistics', '/pulse', '/c', '/banks', '/fx', '/gold', '/oil', '/silver', '/currencies', '/news', '/portfolio', '/watchlist', '/alerts', '/login', '/signup', '/forgot-password', '/verify-email', '/auth/reset', '/profile', '/about', '/contact', '/legal', '/privacy', '/analysis']
