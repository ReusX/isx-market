...
/*
 * Suspended-listing rule · shared by /market, /companies and the homepage top
 * list so all three agree on what counts as a live price.
 *
 ...
 * companies in the default mcap sort — a bank that has not traded since 2024
