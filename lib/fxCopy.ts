...
export function buildFxFaq(fx: FxData | null): FxQa[] {
  ...
  return [
    ...
    /* The next three are the reader's own words, from Google Trends (Iraq,
       September 2026): «الورق» is street slang for the $100 note, «بيش» is
       the Iraqi «how much», and بورصة الكفاح is where the Baghdad closing
       rate is actually set — which is the figure this page shows. */
    {
    ...
    {
      q: 'كم سعر الدولار في بورصة الكفاح اليوم؟',
      a: market
    ...
    },
    {
      ...
      a: market
        ? `الدولار اليوم بـ ${ar(market)} دينار في السوق، و${ar(official)} دينار بالسعر الرسمي للبنك المركزي. ` +
          `100 دولار = ${hundredMarket} دينار في السوق.`
        : `الدولار بالسعر الرسمي ${ar(official)} دينار، وسعر السوق يكون عادة أعلى ويُعرض أعلى الصفحة عند توفره.`,
    },
    {
