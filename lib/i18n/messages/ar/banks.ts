...
export const banks = {
  ...
  introJoin: '، ',
  /* ── Editorial layer · the research package of 14 September 2026 ────── */
  ed: {
    verdict: 'الخلاصة',
    suitableFor: 'يناسب',
    watchOut: 'انتبه',
    confidenceLabel: 'ثقة البيانات',
    coverage: {
      overall: 'تقييم أولي',
      partial: 'تقييم جزئي',
      products: 'منتجات موثقة، بلا تقييم',
      limited: 'أدلة محدودة',
    },
    coverageHint: {
      overall: 'رقم عام مشروط؛ يستثني الدعم',
      partial: (n: string) => `${n} من 6 محاور مقيّمة`,
      products: 'شروط منشورة دون درجات',
      limited: 'لا منتجات مختارة ولا درجات',
    },
    ratings: 'التقييم التحريري',
    ratingsWhat: 'درجات تحريرية من بحث مكتبي — ليست تقييماً لسلامة الوديعة ولا تصنيفاً ائتمانياً، ولم نجرِ تجربة عملية.',
    overall: 'الدرجة العامة',
    overallCovers: (pct: string) => `تغطي ${pct}% من الأوزان`,
    notRated: 'غير مقيّم',
    notRatedHint: 'لا تعني صفراً؛ لم تتوفر أدلة كافية',
    outOf5: 'من 5',
    outOf10: 'من 10',
    weight: (w: string) => `الوزن ${w}%`,
    confidence: { low: 'ثقة منخفضة', medium: 'ثقة متوسطة', high: 'ثقة عالية', limited: 'ثقة محدودة', insufficient: 'أدلة غير كافية' },
    category: {
      mobile: 'التجربة الرقمية',
      support: 'الدعم وحل المشاكل',
      fees: 'الرسوم والقيمة اليومية',
      payments: 'البطاقات والدفع والتحويل',
      access: 'فتح الحساب والوصول',
      products: 'فائدة منتجات الادخار والتمويل',
    },
    methodology: 'كيف نقيّم',
    products: 'المنتجات المهمة',
    productsNote: 'منتج أو اثنان اختارهما البحث؛ سعر واحد لكل منتج، مع عملته ومدته وشرطه.',
    noRateSelected: 'لا نسبة مختارة',
    basis: {
      annual: 'سنوياً',
      annual_from: 'سنوياً، يبدأ من',
      annual_declining: 'سنوياً على الرصيد المتناقص',
      declining_unannualized: 'على الرصيد المتناقص، دون أساس سنوي مثبت',
      expected_profit_not_guaranteed: 'ربح متوقع، غير مضمون',
      financing_return_only: 'عائد التمويل فقط',
      unstated: 'أساس الاحتساب غير موضح',
      flat: 'بالقسط الثابت',
    },
    notReconfirmed: 'منشور ولم يعد المصرف تأكيده',
    detailsToggle: 'الشروط والتفاصيل',
    fees: 'الرسوم المهمة',
    feesNote: 'من التعرفة المنشورة؛ الرسوم ليست فائدة.',
    experience: 'التجربة الفعلية',
    official: 'ما يعلنه المصرف',
    reported: 'ما يقوله المستخدمون',
    reportedNote: 'عينة مراجعات ظاهرة على المتجر، لا كل التقييمات. تجارب أفراد، لا حقائق مثبتة.',
    storeRating: (store: string) => `تقييم ${store}`,
    storefront: (s: string) => `متجر ${s}`,
    appLink: 'صفحة التطبيق الصحيح',
    noVerifiedServices: 'لم نتحقق من خدمات منشورة لهذا المصرف.',
    noExperience: 'لم نجد عينة تجارب تكفي للحكم. هذا لا يعني أن التجربة جيدة أو سيئة.',
    faqs: 'أسئلة شائعة',
    links: 'روابط مفيدة',
    sources: 'المصادر',
    sourcesToggle: (n: string) => `المصادر (${n})`,
    observed: (d: string) => `اطُّلع عليها ${d}`,
    editorialNotice: 'ملف تحريري قائم على بحث مكتبي، وليس اعتماداً من المصرف.',
    colSuits: 'يناسب',
    colDigital: 'التجربة الرقمية',
    colPick: 'منتج مختار',
    colCoverage: 'تغطية البحث',
    noPick: '—',
