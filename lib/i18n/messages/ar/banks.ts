...
export const banks = {
  ...
  hub: {
    ...
    guides: 'أدلّة',
    ranking: {
      failed: 'تعذّر تحميل جدول المصارف الآن.',
      caption: (years: string) => `المصارف المدرجة في بورصة العراق مرتّبة بحسب إجمالي الموجودات في آخر قوائم مالية سنوية منشورة (${years}) · الأرقام بالدينار العراقي`,
      cols: { bank: 'المصرف', type: 'النوع', assets: 'الموجودات', net: 'صافي الربح', deposits: 'ودائع العملاء', equity: 'حقوق الملكية', roe: 'العائد على الملكية', year: 'السنة' },
      withheld: (names: string) => `غير مرتّبة لأن أرقامها المستخرجة من القوائم غير موثوقة بعد: ${names}.`,
      sep: '، ',
      unfiled: (names: string) => `لا قوائم سنوية مفهرسة لها: ${names}.`,
    },
    guideBanks: 'أفضل البنوك في العراق 2026 — ترتيب المصارف بالأرقام',
    guideCards: 'أفضل بطاقات الدفع الإلكتروني في العراق 2026',
    guidePension: 'تحديث بيانات المتقاعدين 2026: الرابط والخطوات',
  ...
  rates: {
    deposits: {
      title: 'فوائد الودائع في المصارف العراقية',
      note: 'كل وديعة لأجل وحساب توفير نشر المصرف شروطه على موقعه، والنسبة كما أعلنها للأفراد بالدينار ما لم يُذكر غير ذلك. لا نتحقق من النسب مع المصرف مباشرة، والرقم الذي مضى عليه أكثر من سنة يُعرض بتاريخه. المصرف الذي يسمّي وديعة ولا ينشر نسبتها يظهر كذلك.',
      seoTitle: 'فوائد الودائع في المصارف العراقية · مقارنة النسب المنشورة',
      seoDescription: 'مقارنة فوائد الودائع لأجل وحسابات التوفير كما تنشرها المصارف العراقية على مواقعها: النسبة، المدة، الحد الأدنى للمبلغ، وتاريخ التحقق.',
      empty: 'لا ودائع منشورة.',
    },
    loans: {
      title: 'فوائد القروض والتمويل في المصارف العراقية',
      note: 'كل قرض وتمويل نشر المصرف شروطه على موقعه: النسبة كما أعلنها، أساس احتسابها، المدة والحد الأقصى للمبلغ. لدى المصارف الإسلامية النسبة هامش مرابحة أو عائد تمويل لا فائدة. لا نتحقق من النسب مع المصرف مباشرة.',
      seoTitle: 'فوائد القروض في المصارف العراقية · مقارنة النسب المنشورة',
      seoDescription: 'مقارنة القروض الشخصية وقروض السيارات والسكن والأعمال كما تنشرها المصارف العراقية: النسبة، أساس الاحتساب، المدة، الحد الأقصى للمبلغ، وتاريخ التحقق.',
      empty: 'لا قروض منشورة.',
    },
    kinds: { deposit_savings: 'توفير', deposit_term: 'وديعة لأجل', account_current: 'حساب جارٍ', loan_personal: 'شخصي', loan_auto: 'سيارة', loan_home: 'سكني', loan_business: 'أعمال', advance: 'سلفة' },
    filters: { all: 'الكل', conventional: 'تقليدي', islamic: 'إسلامي', rated: 'بنسبة منشورة' },
    cols: { bank: 'المصرف', product: 'المنتج', rate: 'النسبة', basis: 'الأساس والشروط', term: 'المدة', amount: 'المبلغ', verified: 'آخر تحقق' },
    noRate: 'لم ينشر المصرف نسبة',
    dated: (d: string) => `نسبة منشورة بتاريخ ${d}`,
    upTo: (v: string) => `حتى ${v}`,
    from: (v: string) => `من ${v}`,
    fromTo: (a: string, b: string) => `${a} – ${b}`,
    shown: (n: string) => `${n} منتجاً`,
    asOf: (d: string) => `آخر تحقق ${d}`,
    about: {
      title: 'عن هذه الأرقام',
      body: [
        'كل صف منتج نشر المصرف شروطه على موقعه، والنسبة هي السيناريو الاعتيادي للأفراد كما أعلنه المصرف مع شروطه؛ نسبة أخرى بشروط أخرى تظهر في صفحة المصرف.',
        'النسب كما نشرتها المصارف ولم نتأكد منها مباشرة. النسبة التي نشرها المصرف قبل أكثر من سنة تبقى بتاريخها ولا تُعرض كعرض حالي.',
        'المصارف التي لا تظهر هنا إما لا تنشر شروط منتجاتها، أو تعذّر فتح مواقعها من خارج العراق، أو لم يُبحث فيها بعد. غياب المصرف هنا لا يعني أنه لا يقدّم المنتج.',
      ],
    },
  },
}
