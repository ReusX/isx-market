...
export const statistics = {
  ...
  page: {
    ...
    sub:     { overview: 'نظرة عامة', flow: 'التدفق الأجنبي', ownership: 'هيكل الملكية', holders: 'كبار المساهمين' },
    activity: 'نشاط السوق',
    ...
    about: {
      ...
      body: [
        ...
        'حصص القطاعات من التقرير الشهري للبورصة، ويصدر بعد نهاية الشهر بأيام. تدفق الأجانب من ورقة غير العراقيين في النشرة اليومية. هيكل الملكية من تقرير مركز الإيداع الشهري.',
      ],
    },
  },
}
