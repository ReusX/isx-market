...
export const statistics = {
  ...
  /** The rebuilt /statistics hub (redesign). */
  page: {
    eyebrow: 'الأسواق',
    lede:    'نشاط بورصة العراق عبر الزمن: كم يُتداول، وأين، ومن يشتري. أرقام رسمية من نشرات السوق اليومية والشهرية.',
    sub:     { overview: 'نظرة عامة', flow: 'التدفق الأجنبي', ownership: 'الملكية الأجنبية', holders: 'كبار المساهمين' },
    activity: 'نشاط السوق',
    activityNote: (grain: string) => `كل عمود ${grain} · مرّر لعرض القيمة`,
    grain:   { session: 'جلسة', week: 'أسبوع', month: 'شهر' },
    total:   'مجموع الفترة',
    perSession: 'متوسط الجلسة',
    best:    'أعلى جلسة',
    sessions: 'الجلسات',
    vsPrev:  (pct: string) => `${pct} عن الفترة السابقة`,
    noPrev:  'لا فترة سابقة بالطول نفسه',
    sectors: 'أين يتداول السوق',
    sectorsNote: (month: string) => `حصة كل قطاع من قيمة التداول في ${month}. الجدول الشهري يصدر بعد نهاية الشهر.`,
    ofValue: 'من قيمة التداول',
    foreign: 'المستثمر الأجنبي',
    foreignNote: (n: string) => `صافي تداول الأجانب في آخر ${n} جلسة`,
    netBuy:  'صافي شراء',
    netSell: 'صافي بيع',
    ownership: 'من يملك السوق',
    ownershipNote: (month: string) => `حصة العراقيين والأجانب من الأسهم المودعة · ${month}`,
    iraqis:  'عراقيون',
    foreigners: 'أجانب',
    more:    'التفاصيل',
    about: {
      ...
      body: [
        'قيمة التداول وحجمه وعدد الصفقات من نشرة بورصة العراق اليومية، جلسة بجلسة منذ 5 مارس 2015 حين أُعيد تأسيس المؤشر. المجاميع الشهرية والأسبوعية هي مجموع الجلسات، والمتوسط يُقسم على الجلسات الفعلية لا الأيام.',
        'حصص القطاعات من التقرير الشهري للبورصة، ويصدر بعد نهاية الشهر بأيام. تدفق الأجانب من ورقة غير العراقيين في النشرة اليومية. الملكية الأجنبية من تقرير مركز الإيداع الشهري.',
      ],
    },
  },
}
