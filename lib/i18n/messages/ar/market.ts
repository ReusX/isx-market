...
export const market = {
  ...
  page: {
    ...
    rail: { market: 'السوق', board: 'جدول الشركات', companies: 'دليل الشركات', screener: 'رادار الأسهم', heatmap: 'خريطة السوق', statistics: 'الإحصاءات', pulse: 'نبض السوق', news: 'الأخبار' },
    ...
    /** /companies · the directory: who is listed, not what the prices are. */
    directory: {
      eyebrow: 'الأسواق',
      title:   'الشركات المدرجة في بورصة العراق',
      intro:   (n: string, s: string) => `${n} شركة مدرجة في سوق العراق للأوراق المالية موزّعة على ${s} قطاعات. دليل بلا أسعار: من هي الشركة، قطاعها، رأس مالها، وحالة تداولها — والأسعار على صفحة كل شركة.`,
      search:  'ابحث عن شركة أو رمز…',
      status:  { all: 'الكل', active: 'نشطة', untraded: 'لم تُتداول مؤخراً', suspended: 'موقوفة' },
      capital: 'رأس المال',
      founded: 'تأسست',
      listed:  'أُدرجت',
      hq:      'المقر',
      active:  'نشطة · تداولت في آخر جلسة',
      lastTrade: (d: string) => `آخر تداول ${d}`,
      suspended: (d: string) => `موقوفة عن التداول · آخر تداول ${d}`,
      count:   (n: string) => `${n} شركة`,
      tier:    'السوق',
      tiers:   { 1: 'النظامي', 2: 'الثاني' } as Record<number, string>,
      bySector: (parts: string) => `حسب القطاع: ${parts}.`,
      ...
      about: {
        title: 'عن الإدراج في بورصة العراق',
        body: [
          'الشركة المدرجة هي شركة مساهمة وافقت هيئة الأوراق المالية على تداول أسهمها في سوق العراق للأوراق المالية. رأس المال المذكور هو رأس المال المدفوع بالدينار، وبما أن القيمة الاسمية للسهم دينار واحد فهو أيضاً عدد الأسهم المصدرة.',
          'السوق يضم ثلاث فئات: السوق النظامي للشركات المستوفية لشروط الإفصاح، والسوق الثاني للشركات الأصغر أو الأحدث، وسوق غير المدرجة. المصارف هي القطاع الأكبر عدداً، تليها الصناعة والفنادق والسياحة والتأمين والزراعة والخدمات والاتصالات والاستثمار.',
          'حالة التداول تُقرأ من آخر جلسة: الشركة النشطة تداولت فيها، والشركة التي لم تُتداول مؤخراً تحتفظ بآخر سعر لها، والموقوفة لم تُتداول لأكثر من ستين يوماً — غالباً بقرار من الهيئة لتأخر الإفصاح أو لأسباب أخرى.',
        ],
      },
    },
    board: {
