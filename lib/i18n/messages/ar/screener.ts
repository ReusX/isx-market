...
export const screener = {
  ...
  page: {
    eyebrow:  'الأسواق',
    lede:     'ابدأ من جاهز فرز، أو اكتب شروطك: على الشركة أن تحقق كل الشروط معاً. الشركة التي لا يتوفر لها قياس ما تُستبعد من ذلك الشرط فقط.',
    presets:  'جاهزات الفرز',
    ...
    titles: {
      all:      'مستكشف الأسهم العراقية · فلترة أسهم بورصة العراق',
    ...
    about: {
      title: 'كيف يعمل المستكشف',
      body: [
        'المستكشف يفرز شركات بورصة العراق بسبعة مقاييس: السعر، التغيّر خلال فترة تختارها، الموقع داخل مدى 52 أسبوعاً، السيولة اليومية، القيمة السوقية، صافي تداول الأجانب خلال 30 يوماً، ومكرر الربحية.',
