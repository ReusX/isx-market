...
export const home = {
  ...
  /**
   * The landing hero and the four doors. One sentence per door: what it is
   * for, in the reader's words, not the site's. «قريباً» marks a page that
   * does not exist yet and is shown as a promise, not a link.
   */
  landing: {
    title:    'سوق العراق،\nبوضوح.',
    intro:    'أسعار بورصة العراق، بيانات الشركات، نسب المصارف، والدولار والنفط والذهب — في مكان واحد، وبلغة يفهمها الجميع.',
    intro2:   'بيانات رسمية، تُحدَّث مع كل جلسة.',
    explore:  'ابدأ من السوق',
    scroll:   'الأقسام',
    soon:     'قريباً',
    doors: {
      markets: {
        ...
        links: {
          market: 'السوق', companies: 'الشركات', screener: 'مستكشف الأسهم', heatmap: 'خريطة السوق',
          statistics: 'الإحصاءات', pulse: 'نبض السوق', portfolio: 'المحفظة', watchlist: 'قائمة المتابعة', alerts: 'التنبيهات',
        },
      },
      banking: {
        name: 'البنوك والتمويل',
        lede: 'كل مصرف عراقي بتقييم مستقل، ونسبة واحدة واضحة لكل وديعة وقرض.',
        links: { banks: 'المصارف', deposits: 'الودائع', loans: 'القروض والتمويل', cards: 'البطاقات والتطبيقات' },
      },
      economy: {
        name: 'الاقتصاد العراقي',
        lede: 'الدولار في السوق، النفط الذي يموّل الدولة، والذهب الذي يدّخره الناس.',
        links: { fx: 'الدولار', oil: 'النفط', gold: 'الذهب', cbi: 'البنك المركزي', budget: 'الموازنة' },
      },
      learn: {
        name: 'تعلّم',
        lede: 'من أول سهم إلى قراءة القوائم المالية. بالعربية، وبلا تعقيد.',
        links: { learn: 'دليل التعلّم', zero: 'التداول من الصفر', news: 'الأخبار', research: 'الأبحاث' },
      },
    },
  },
}
